      ...
      array(
        ...
        'settings'    => array(
          ...
          array(
            ...
            'id'          => 'slider_link',
            'type'        => 'text',
            'desc'        => 'Where slide will link (leave empty to not use link)' ,
            'std'         => '',
            'rows'        => '',
            'post_type'   => '',
            'taxonomy'    => '',
...
array(
  ...
  'id'          => 'pp_language',
  'type'        => 'select',
  'desc'        => 'Available with <a href="http://wpml.org/?aid=27926&amp;affiliate_key=LikrvB9gJOkU" rel="nofollow">WPML</a> plugin',
  'choices'     => array(
    array(
      'label'       => 'Enable',
      'value'       => 'enable'
...
array(
  'label'       => 'Responsiveness switch',
  'id'          => 'pp_mediaqueries',
  'type'        => 'select',
  'desc'        => 'If you want to disable mobile view of site, you can do it here ',
  'choices'     => array(
    array(
      'label'       => 'Disable',
      'value'       => 'no'
...
array(
  'label'       => 'jCarousel autoscroll ',
  'id'          => 'pp_jcarousel_auto',
  'type'        => 'select',
  'desc'        => 'jCarousel is used in "Recent portfolio" carousel, by default it\'s operated by clicking arrows, but you can turn on autoscroll here. It is global setting so it will change every instance of jCarousel on your site',
  'choices'     => array(
    array(
      'label'       => 'Disable',
      'value'       => 'no'
...
array(
  'label'       => 'For single portfolio item, display title of images as captions in slider?',
